...
---@param shouldAllowMovement boolean
---@return string shoppingSessionUUIDStr
function C_CatalogShop.OpenCatalogShopInteraction(shouldAllowMovement) end
---@param categoryId number
---@param sectionId number
---@param catalogShopProductID number
...
function C_HouseExterior.GetCurrentHouseExteriorTypeName() end
...
---@return boolean nudgeEnabled
function C_HousingBasicMode.IsNudgeEnabled() end
...
---@param nudgeEnabled boolean
function C_HousingBasicMode.SetNudgeEnabled(nudgeEnabled) end
---@param catalogEntryID any
...
---@return boolean isIncludingMarketEntries
function IsIncludingMarketEntries() end
---@return boolean isActive
function IsOwnedOnlyActive() end
...
---@param includeMarketEntries boolean
function SetIncludeMarketEntries(includeMarketEntries) end
---@param isActive boolean
function SetOwnedOnly(isActive) end
---@param callback any
...
function C_HousingDecor.GetMaxDecorPlaced() end
...
---@param neighborhoodGuid any
function C_Housing.RequestHouseFinderNeighborhoodData(neighborhoodGuid) end
...
---@param spellID number
---@return boolean isPriorityAura
function C_Spell.SpellIsPriorityAura(spellID) end
...
---@return table auras
function C_UnitAuras.GetUnitAuras(unit, filter, maxCount) end
---@param unit any
---@param auraInstanceID number
---@param filter any
---@return boolean isFiltered
